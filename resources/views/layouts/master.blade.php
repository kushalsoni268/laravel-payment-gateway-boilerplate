            ...
            <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
                ...
                <li class="nav-item {{ Route::is('products')  ? 'active' : '' }}">
                    <a class="d-flex align-items-center" href="{{ route('products.index') }}">
                        <i data-feather="grid"></i><span class="menu-title text-truncate" data-i18n="Dashboards">Products</span>
                    </a>
                </li>

                <li class="nav-item {{ Route::is('checkout')  ? 'active' : '' }}">
                    <a class="d-flex align-items-center" href="{{ route('checkout') }}">
                        <i data-feather="credit-card"></i><span class="menu-title text-truncate" data-i18n="Dashboards">Checkout</span>
                    </a>
                </li>

                <li class="nav-item {{ Route::is('cashier.checkout')  ? 'active' : '' }}">
                    <a class="d-flex align-items-center" href="{{ route('cashier.checkout') }}">
                        <i data-feather="credit-card"></i><span class="menu-title text-truncate" data-i18n="Dashboards">Checkout (Cashier)</span>
                    </a>
                </li>

                <li class="nav-item"><a class="d-flex align-items-center"><i data-feather="align-justify"></i><span class="menu-title text-truncate" data-i18n="Dashboards">Transactions</span></a>
                    <ul class="menu-content">
                        <li class="{{ Route::is('stripe-transaction')  ? 'active' : '' }}"><a class="d-flex align-items-center" href="{{ route('stripe-transaction') }}"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="Analytics">Stripe</span></a>
                        </li>
                        <li class="{{ Route::is('paypal-transaction')  ? 'active' : '' }}"><a class="d-flex align-items-center" href="{{ route('paypal-transaction') }}"><i data-feather="circle"></i><span class="menu-item text-truncate" data-i18n="eCommerce">PayPal</span></a>
                        </li>                        
                    </ul>
                </li>
            </ul>
