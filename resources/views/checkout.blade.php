                    ...
                    <div id="step-payment" class="content">
                        <div class="row match-height mt-2">
                                            ...
                                            <div class="row">
                                                <div class="col-12">
                                                    <div class="form-group mb-2">
                                                        ...
                                                        <input type="text" name="card_number" id="card_number" class="form-control" placeholder="2133 3244 4567 8921">
                                                    </div>
                                                </div>
                                                <div class="col-sm-6 col-12">
                                                    <div class="form-group mb-2">
                                                        <label for="payment-expiry">Expiry</label>
                                                        <input type="text" name="expiry_date" class="form-control" placeholder="MM/YY" id="expiry_date" />
                                                    </div>
                                                </div>
                                                <div class="col-sm-6 col-12">
                                                    <div class="form-group mb-2">
                                                        <label for="payment-cvv">CVV / CVC</label>
                                                        <input type="text" name="cvv_number" id="cvv_number" class="form-control" placeholder="123" maxlength="3">
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-group mb-2">
                                                ...
                                                <div class="col-12">
                                                    <button type="button" class="btn btn-primary btn-block waves-effect waves-float waves-light">Make Payment</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
                            ...
                            <div class="col-lg-7 col-md-6 col-12">
                                <div class="card card-payment">
                                    ...
                                    <div class="card-body">
                                        <form action="{{ route('stripe.payment') }}" method="POST" class="form" id="stripe-payment-form">
                                        @csrf  
                                            <div class="row">
                                                        ...
                                                        <div class="business-item">
                                                            <div class="d-flex align-items-center justify-content-between">
                                                                <div class="custom-control custom-radio">
                                                                    <input type="radio" id="saved-card-{{ $key }}" name="select_card_btn" class="custom-control-input" value="0" data-id="{{ $key }}" data-token="{{ $value->id }}">
                                                                    <label class="custom-control-label" for="saved-card-{{ $key }}">**** **** **** {{ $value->card->last4 }}</label>
                                                                    
                                                                </div>                                                                                                                                
                                                                <div id="cvc-element-{{ $key }}" style="width:15%"></div>
                        ...
                        <div class="row match-height">
                            ...
                            <div class="col-lg-7 col-md-6 col-12">
                                <div class="card card-payment">
                                    <div class="card-header">
                                        <h4 class="card-title">PayPal Payment</h4>
                                        <h4 class="card-title text-primary">${{ $total }}</h4>
                                    </div>
                                    <div class="card-body">
                                        <form action="{{ route('paypal.payment') }}" method="POST" class="form">
                                        @csrf
                                            <div class="row">
                                                <div class="col-12">
                                                    {{ Form::hidden('products', $products, array('id' => 'products')) }}
                                                    {{ Form::hidden('total', $total, array('id' => 'total')) }}
                                                    <button type="submit" id="paypal-payment-btn" class="btn btn-primary btn-block waves-effect waves-float waves-light">Make Payment</button>
                                                </div>
                                            </div>
                                        </form>
                                    </div>
...
$(document).ready(function () {
    ...
    $("input[name$='select_card_btn']").click(function() {
        ...
        if(value == 1){   
            ...
            /* Create CVC Element Start */
            var cvc_ele_obj = Stripe('pk_test_51IYAIBSBdMBtLHAgGz0qDnwlqstz9lMpH2YY100yKnXUVn3cjtkxhShiggvLHSsoJxw8HJjvl7fnu9rbIFP0PU8t00uPxqKFk4');
            var cvc_element = cvc_ele_obj.elements();
            ...
            cardCvc = cvc_element.create('cardCvc', {style: cvc_style});
            cardCvc.mount('#cvc-element-' + id);
            /* Create CVC Element End */
    ...
    // var creditCard = $('#card_number');
    // var cvvNumber = $('#cvv_number');
    ...
    // cvvNumber.on("keypress", function (e) {
    //     var arr = [];
    //     var kk = e.which;
